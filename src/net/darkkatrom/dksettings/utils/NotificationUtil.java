...
//        BitmapFactory.decodeResource(mResources, R.drawable.default_wallpaper, options);

//        final int height = options.outHeight;
//        final int width = options.outWidth;
//        final int reqWidth = mResources.getDimensionPixelSize(R.dimen.notification_big_picture_width);
//        final int reqHeight = mResources.getDimensionPixelSize(R.dimen.notification_big_picture_height);
//        int inSampleSize = 1;
...
//        options.inSampleSize = inSampleSize;
        ...
        return BitmapFactory.decodeResource(mResources, R.drawable.default_wallpaper, options);
    }
}
