...
public class QuickSettingsTileBattery extends SettingsBaseFragment implements
    ...
    public void refreshSettings() {
        ...
        addPreferencesFromResource(R.xml.quick_settings_tile_battery);
        mResolver = getActivity().getContentResolver();

        final boolean isBatteryIconCircle = Settings.System.getInt(mResolver,
                Settings.System.QS_TILE_BATTERY_METER_TYPE, 0) == CIRCLE;
        final boolean isBatteryIconArcs = Settings.System.getInt(mResolver,
                Settings.System.QS_TILE_BATTERY_METER_TYPE, 0) == ARCS;
        final boolean showCircleDotted = Settings.System.getInt(mResolver,
                Settings.System.QS_TILE_BATTERY_METER_CIRCLE_DOT_INTERVAL, 0) != 0;
        ...
        int type = Settings.System.getInt(mResolver,
                Settings.System.QS_TILE_BATTERY_METER_TYPE, ICON_VERTICAL);
        ...
        mShowText.setChecked(Settings.System.getInt(mResolver,
    ...
    public static class MyAlertDialogFragment extends DialogFragment {
        ...
        QuickSettingsTileBattery getOwner() {
            return (QuickSettingsTileBattery) getTargetFragment();
        }
            ...
            switch (id) {
                case DLG_RESET:
                    ...
                    .setNeutralButton(R.string.dlg_reset_android,
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.QS_TILE_BATTERY_METER_TYPE, ICON_VERTICAL);
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.QS_TILE_BATTERY_METER_SHOW_TEXT, 0);
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.QS_TILE_BATTERY_METER_CIRCLE_DOT_INTERVAL, 0);
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.QS_TILE_BATTERY_METER_CIRCLE_DOT_LENGTH, 0);
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.QS_TILE_BATTERY_METER_CUT_OUT_TEXT, 1);
                    ...
                    .setPositiveButton(R.string.dlg_reset_darkkat,
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.QS_TILE_BATTERY_METER_TYPE, CIRCLE);
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.QS_TILE_BATTERY_METER_SHOW_TEXT, 1);
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.QS_TILE_BATTERY_METER_CIRCLE_DOT_INTERVAL, 2);
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.QS_TILE_BATTERY_METER_CIRCLE_DOT_LENGTH, 3);
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.QS_TILE_BATTERY_METER_CUT_OUT_TEXT, 0);
                            getOwner().refreshSettings();
                        }
                    })
                    .create();
