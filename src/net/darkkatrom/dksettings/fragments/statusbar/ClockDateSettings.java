...
public class ClockDateSettings extends SettingsBaseFragment implements
    ...
    public void refreshSettings() {
        ...
        if (isClockEnabled) {
            ...
            mShowSeconds.setChecked(Settings.System.getInt(mResolver,
                    Settings.System.STATUS_BAR_SHOW_SECONDS, 0) == 1);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mClockDatePosition) {
            ...
            boolean value = (Boolean) newValue;
            Settings.System.putInt(mResolver,
                    Settings.System.STATUS_BAR_SHOW_SECONDS, value ? 1 : 0);
            return true;
                ...
                case DLG_RESET:
                    ...
                    .setNeutralButton(R.string.dlg_reset_android,
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.STATUS_BAR_SHOW_SECONDS, 0);
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.STATUS_BAR_AM_PM, 2);
                            Settings.System.putInt(getOwner().mResolver,
