...
public class ColorsNotification extends SettingsColorPickerFragment implements
    ...
    public void refreshSettings() {
        ...
        if (mCustomizeColors) {
            ...
            mPrimaryBackgroundColor.setNewColor(intColor);
            ...
            mSecondaryBackgroundColor.setNewColor(intColor);
            hexColor = String.format("#%08x", (0xffffffff & intColor));
 ...
 */
            ...
            mDismissAllColor.setNewColor(intColor);
            hexColor = String.format("#%08x", (0xffffffff & intColor));
