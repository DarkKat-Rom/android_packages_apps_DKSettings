...
public class ColorsNavigationBar extends SettingsColorPickerFragment implements
    ...
    private static final String PREF_ICON_COLOR =
            "colors_navigation_bar_icon_color";
    private static final String PREF_RIPPLE_COLOR =
            "colors_navigation_bar_ripple_color";
    ...
    public void refreshSettings() {
        ...
        intColor = NavigationBarColorHelper.getIconColor(getActivity());
        ...
        intColor = NavigationBarColorHelper.getRippleColor(getActivity());
        mRippleColor.setNewColor(intColor);
        mRippleColor.setResetColors(ColorConstants.WHITE,
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mIconColor) {
            ...
            intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.System.putInt(mResolver,
                    Settings.System.NAVIGATION_BAR_RIPPLE_COLOR, intHex);
            refreshSettings();
            return true;
        }
        return false;
                    ...
                    .setPositiveButton(R.string.dlg_reset_darkkat,
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Settings.System.putInt(getOwner().mResolver,
                                    ...
                                    ColorConstants.HOLO_BLUE_LIGHT);
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.NAVIGATION_BAR_RIPPLE_COLOR,
                                    ColorConstants.HOLO_BLUE_LIGHT);
                            getOwner().refreshSettings();
                        }
                    })
