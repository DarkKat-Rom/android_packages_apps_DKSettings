...
public class SettingsActivity extends PreferenceActivity {
    ...
    public static class ThemeColorsSettingsActivity extends SettingsActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (savedInstanceState == null && getIntent().getStringExtra(EXTRA_SHOW_FRAGMENT) == null) {
                getFragmentManager().beginTransaction()
                        .replace(android.R.id.content, new ThemeColorsSettings())
                        .commit();
            }
        }
    }

    public static class WeatherSettingsActivity extends SettingsActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (savedInstanceState == null && getIntent().getStringExtra(EXTRA_SHOW_FRAGMENT) == null) {
                getFragmentManager().beginTransaction()
                        .replace(android.R.id.content, new WeatherSettings())
                        .commit();
            }
        }
    }
    ...
    public static class LockScreenSettingsActivity extends SettingsActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (savedInstanceState == null && getIntent().getStringExtra(EXTRA_SHOW_FRAGMENT) == null) {
                getFragmentManager().beginTransaction()
                        .replace(android.R.id.content, new LockScreenSettings())
                        .commit();
            }
        }
    }
    ...
    public static class StatusBarSettingsActivity extends SettingsActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (savedInstanceState == null && getIntent().getStringExtra(EXTRA_SHOW_FRAGMENT) == null) {
                getFragmentManager().beginTransaction()
                        .replace(android.R.id.content, new StatusBarSettings())
                        .commit();
            }
        }
    }
    ...
    public static class QuickSettingsActivity extends SettingsActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (savedInstanceState == null && getIntent().getStringExtra(EXTRA_SHOW_FRAGMENT) == null) {
                getFragmentManager().beginTransaction()
                        .replace(android.R.id.content, new QuickSettings())
                        .commit();
            }
        }
    }

    public static class RecentsSettingsActivity extends SettingsActivity {
    ...
    public static class PowerButtonSettingsActivity extends SettingsActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (savedInstanceState == null && getIntent().getStringExtra(EXTRA_SHOW_FRAGMENT) == null) {
                getFragmentManager().beginTransaction()
                        .replace(android.R.id.content, new PowerButtonSettings())
                        .commit();
            }
        }
    }
